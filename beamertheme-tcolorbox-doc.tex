...
\date{Version v1.4 \textendash{} 2026/01/16}
...
\subsection{Using with \texttt{\textbackslash pause}}
...
\subsection{Theorem title font}

Normally, theorem titles are upright in beamer. To get the same result with the \saminline|tcolorbox| inner theme, use \saminline|\setbeamerfont{block title}{shape=\upshape}|.
