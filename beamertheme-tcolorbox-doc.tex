...
\item for themes which don't set the \lstinline|block body.fg| colour, e.g.\ the default theme, the block body will be shown in the same colour as the title and instead of the normal text colour.
