...
\begin{description}
\item[rounded] controls if corners are rounded or sharp
\item[shadow] controls if the block has a shadow
\item[shaded] controls if there is a short colour gradient between the title and the body or if there is a sharp border between the colours
\end{description}
